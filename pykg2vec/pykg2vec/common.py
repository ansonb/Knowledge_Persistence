...
class KGEArgParser:
    ...
    def __init__(self):
        ...
        self.general_group.add_argument('-ts', dest='test_step', default=10, type=int, help='Test every _ epochs on valid set')
        self.general_group.add_argument('-es', dest='early_stopping', default=True, type=bool, help='Whether to stop training early')
        # self.general_group.add_argument('-te', dest='test_every', default=10, type=int, help='Test every _ epochs on test set')
        ...
        self.general_group.add_argument('-ep', dest='embeddings', default='../embeddings', type=str, help="The folder name to save the embeddings.")
        ...
        self.general_group.add_argument('-seed', dest='seed', default=42, type=int, help='The random seed for reproducibility.')
        self.general_group.add_argument('-fraction', dest='fraction', default=1.0, type=float, help='The fraction of triples to sample.')
        self.general_group.add_argument('-test_only', dest='test_only', default=False, type=bool, help='Whether to only perform testing (no training)')
...
class HyperparameterLoader:
    ...
    def load_hyperparameter(self, dataset_name, algorithm):
        ...
        if d_name in self.hyperparams and a_name in self.hyperparams[d_name]:
            ...
            return params
        if dataset_name in self.hyperparams and a_name in self.hyperparams[dataset_name]:
            params = self.hyperparams[dataset_name][a_name]
            return params
